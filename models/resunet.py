...
from models.blocks import ResidualBlock, UpConv
...
class ResUNet(nn.Module):
    ...
    def __init__(self, in_channels: int = 3, out_channels: int = 1, features: list[int] = None,
        ...
        self.encoder5 = ResidualBlock(features[3], features[4])
        ...
        self.decoder1 = ResidualBlock(features[4], features[3])
        self.decoder2 = ResidualBlock(features[3], features[2])
        self.decoder3 = ResidualBlock(features[2], features[1])
        self.decoder4 = ResidualBlock(features[1], features[0])
